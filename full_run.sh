...
for d in "${DIRS[@]}"; do
    ...
    LM_MODEL="${LM_MODEL:-gemma-4-31b-it}" CLASSIFY_MODEL=nvidia/nemotron-3-nano-4b ./scripts/photo_describe.sh $describe_force -classify --preview-workers 8 --inference-workers 2 "$d"
done
...
CLASSIFY_MODEL=nvidia/nemotron-3-nano-4b ./scripts/classify.sh $classify_reclassify
